...
public class WarehouseResourceImpl implements WarehouseResource {
  ...
  @Override
  @Transactional
  public jakarta.ws.rs.core.Response createANewWarehouseUnit(@NotNull Warehouse data) {
    var warehouse = toDomainWarehouse(data);

    createWarehouseOperation.create(warehouse);

    var created =
        toWarehouseResponse(warehouseRepository.findByBusinessUnitCode(warehouse.businessUnitCode));
