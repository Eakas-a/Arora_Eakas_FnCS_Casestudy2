...
public class StoreResource {
  ...
  // Fires StoreChangedEvent notifications. The event is only actually delivered to
  // StoreLegacySyncObserver once the surrounding JTA transaction commits successfully (see
  // that observer's @Observes(during = TransactionPhase.AFTER_SUCCESS)), so the legacy system
  ...
  public Store update(Long id, Store updatedStore) {
    ...
    storeChangedEvent.fire(new StoreChangedEvent(entity, StoreChangedEvent.Type.UPDATED));
